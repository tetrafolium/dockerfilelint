...
var commands = module.exports = {
  apk_commands : function(
      commands) { return command_parser.filter_commands(commands, 'apk'); },

  // return the subcommand from apk
  apk_subcommand : function(
      apkCommand) { return command_parser.get_subcommand(apkCommand); },
  ...
  apkadd_hasvirtual : function(apkaddCommand) {
    return command_parser.command_has_flag(apkaddCommand, '--virtual') ||
